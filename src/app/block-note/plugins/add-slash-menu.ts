import { BaseSlashMenuItem, BlockNoteEditor, DefaultBlockSchema } from "@blocknote/core";
import { createButton } from "./utils/create-button";

export const addSlashMenu = (editor: BlockNoteEditor, parentElement: HTMLElement) => {
